...
DrawTextXY(-1.75,3,0.0,0.0014, (char*)"    SNOW RA-IL PREVAIL ");

glColor3f(0.7,0.6,0.1);
DrawTextXY(-3.25,1.5,0.0,0.0007, (char*)"     Submitted by :- ");

glColor3f(1.0,0.5,0.0);
DrawTextXY(-2.5,1.2,0.0,0.001, (char*)"       MUKUND B ");
DrawTextXY(1.01,1.2,0.0,0.001, (char*)"        SYED SHOAIB ");
glColor3f(0.7,0.8,0.6);
DrawTextXY(-2.5,0.95,0.0,0.001, (char*)"     (1CD18CS078) ");
DrawTextXY(1,0.95,0.0,0.001, (char*)"        (1CD18CS183) ");

glColor3f(0.7,0.6,0.1);
DrawTextXY(-1.25,0.2,0.0,0.0007, (char*)"     Under the guidance of : ");
glColor3f(1.0,0.8,0.4);
DrawTextXY(-3.25,-.2,0.0,0.001, (char*)"     Prof. PRIYADARSHINI");
DrawTextXY(.25,-.2,0.0,0.001, (char*)"     Prof. JOSEPHINE PREMKUMAR");
DrawTextXY(-2.8,-.5,0.0,0.0007, (char*)"     Associate Professor ");
DrawTextXY(1,-.5,0.0,0.0007, (char*)"     Associate Professor ");
DrawTextXY(-2,-.75,0.0,0.001, (char*)"Cambridge Institute of Technology, Bangalore");
glColor3f(0.8,0.8,0.8);
DrawTextXY(-1,-1,0.0,0.0008, (char*)"     Press c to continue... ");
