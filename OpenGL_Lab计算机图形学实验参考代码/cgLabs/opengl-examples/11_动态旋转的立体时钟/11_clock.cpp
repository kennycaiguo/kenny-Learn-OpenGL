...
void init(void)
{
    ...
    LoadGLTextures(&texture[0], (char*)"clock3.bmp", 1);            //载入纹理贴图
    LoadGLTextures(&texture[1], (char*)"clock3.bmp", 2);
}
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("OpenGL Clock");  //设置窗口的标题
    init();  //初始化资源,这里一定要在创建窗口以后，不然会无效。
    LoadGLTextures(&texture[0], (char*)"clock3.bmp", 1);
    LoadGLTextures(&texture[1], (char*)"clock3.bmp", 2);
